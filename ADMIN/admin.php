<?php // Karol Zieba for Bob Erickson - Last updated 2014-08-25 to add restricted folders. 
$crn  = '92189';                     // Course Number, according to the registrar. This is the only thing to change for each class
